#!/usr/bin/env bash
# tests/helpers.sh - Test framework helpers for claude-code-container
...
STANDALONE_IMAGE="${STANDALONE_IMAGE:-claude-code-container}"
MCP_IMAGE="${MCP_IMAGE:-claude-code-container-chonky}"
